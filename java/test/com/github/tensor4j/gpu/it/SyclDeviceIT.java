...
/**
 * Integration test for SYCL backend native library loading.
 * Requires libtensor4j-sycl.so on java.library.path.
 */
@Tag("gpu-it")
class SyclDeviceIT {
    ...
    @Test
    void syclDeviceInstantiationSucceedsWithNativeLib() throws Exception {
        try {
            Object dev = Class.forName("com.github.tensor4j.gpu.sycl.SyclDevice")
    ...
    @Test
    void syclDeviceReportsMetadata() throws Exception {
        Object dev = Class.forName("com.github.tensor4j.gpu.sycl.SyclDevice")
            .getDeclaredConstructor()
            .newInstance();
